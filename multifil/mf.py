...
class Crown:
    ...
    def to_dict(self):
        ...
        """
        crown_d = self.__dict__.copy()
        crown_d.pop('index')
        crown_d.pop('parent_thick')
        crown_d['crossbridges'] = [xb.address for xb in crown_d['crossbridges']]
        return crown_d
    ...
    def axial_force(self, axial_location=None):
        ...
        axial_force = [xb.axial_force(axial_location) for
...
class ThickFace:
    ...
    def to_dict(self):
        ...
        """
        thickface_d = self.__dict__.copy()
...
class ThickFilament:
    ...
    def to_dict(self):
        ...
        """
        thick_d = self.__dict__.copy()
        thick_d.pop('index')
        thick_d.pop('parent_lattice')
        thick_d['axial'] = list(thick_d['axial'])
        thick_d['crowns'] = [crown.to_dict() for crown in thick_d['crowns']]
        thick_d['rests'] = list(thick_d['rests'])
        thick_d['thick_faces'] = [face.to_dict() for face in thick_d['thick_faces']]
        thick_d['thin_faces'] = [face.address for face in thick_d['thin_faces']]
        return thick_d
